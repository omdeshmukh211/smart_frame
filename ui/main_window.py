...
class MainWindow(QMainWindow):
    ...
    def _setup_shortcuts(self):
        ...
        # Ctrl+Q to quit (useful for development)
    ...
    def closeEvent(self, event):
        ...
        try:
            ...
            logger.exception("Error stopping photo_service")

        try:
            self.music_service.stop()
        except Exception:
            logger.exception("Error stopping music_service")

        # Cleanup state
        try:
            self.app_state.cleanup()
        except Exception:
            logger.exception("Error during app_state.cleanup()")
